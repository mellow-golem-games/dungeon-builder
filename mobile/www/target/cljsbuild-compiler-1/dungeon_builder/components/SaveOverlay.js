...
dungeon_builder.components.SaveOverlay.handle_save = (function dungeon_builder$components$SaveOverlay$handle_save(name,tile_state,terrain_state,loaded_map_name,currentMaps){

return dungeon_builder.scripts.persistence.save_map.call(null,name,tile_state,terrain_state,loaded_map_name,currentMaps);
});
...
dungeon_builder.components.SaveOverlay.SaveOverlay = (function dungeon_builder$components$SaveOverlay$SaveOverlay(active,tile_state,terrain_state,loaded_map_name,currentMaps){
...
return (function (){
return dungeon_builder.components.SaveOverlay.handle_save.call(null,cljs.core.deref.call(null,name),tile_state__$1,terrain_state__$1,loaded_map_name__$1,currentMaps);
});})(name))
], null),"Save"], null)], null);
});
});
