...
return (imgObj["onload"] = (function (){
ctx.drawImage(imgObj,((50) * cljs.core.quot.call(null,((((-1) * event.target.getBoundingClientRect().x) + event.clientX) / new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(canvas_properties)),(50))),(((50) * cljs.core.quot.call(null,((((-1) * event.target.getBoundingClientRect().y) + event.clientY) / new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(canvas_properties)),(50))) - (2)));

return update_canvas_rep.call(null,((50) * cljs.core.quot.call(null,((((-1) * event.target.getBoundingClientRect().x) + event.clientX) / new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(canvas_properties)),(50))),((50) * cljs.core.quot.call(null,((((-1) * event.target.getBoundingClientRect().y) + event.clientY) / new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(canvas_properties)),(50))));
}));
});
