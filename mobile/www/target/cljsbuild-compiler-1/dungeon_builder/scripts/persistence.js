...
dungeon_builder.scripts.persistence.map_rep.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k22146,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__22150 = k22146;
var G__22150__$1 = (((G__22150 instanceof cljs.core.Keyword))?G__22150.fqn:null);
switch (G__22150__$1) {
case "name":
return self__.name;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k22146,else__4388__auto__);
...
return (function (ret__4407__auto__,p__22151){
var vec__22152 = p__22151;
var k__4408__auto__ = cljs.core.nth.call(null,vec__22152,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__22152,(1),null);
...
dungeon_builder.scripts.persistence.map_rep.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__22145){
var self__ = this;
...
dungeon_builder.scripts.persistence.map_rep.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this22147,other22148){
var self__ = this;
var this22147__$1 = this;
return (((!((other22148 == null)))) && ((this22147__$1.constructor === other22148.constructor)) && (cljs.core._EQ_.call(null,this22147__$1.name,other22148.name)) && (cljs.core._EQ_.call(null,this22147__$1.tile_state,other22148.tile_state)) && (cljs.core._EQ_.call(null,this22147__$1.terrain_state,other22148.terrain_state)) && (cljs.core._EQ_.call(null,this22147__$1.__extmap,other22148.__extmap)));
});
...
dungeon_builder.scripts.persistence.map_rep.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__22145){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__22155 = cljs.core.keyword_identical_QMARK_;
var expr__22156 = k__4393__auto__;
if(cljs.core.truth_(pred__22155.call(null,new cljs.core.Keyword(null,"name","name",1843675177),expr__22156))){
return (new dungeon_builder.scripts.persistence.map_rep(G__22145,self__.tile_state,self__.terrain_state,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22155.call(null,new cljs.core.Keyword(null,"tile-state","tile-state",1272649318),expr__22156))){
return (new dungeon_builder.scripts.persistence.map_rep(self__.name,G__22145,self__.terrain_state,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22155.call(null,new cljs.core.Keyword(null,"terrain-state","terrain-state",-2032901945),expr__22156))){
return (new dungeon_builder.scripts.persistence.map_rep(self__.name,self__.tile_state,G__22145,self__.__meta,self__.__extmap,null));
} else {
return (new dungeon_builder.scripts.persistence.map_rep(self__.name,self__.tile_state,self__.terrain_state,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__22145),null));
}
}
}
});
...
dungeon_builder.scripts.persistence.map_rep.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__22145){
var self__ = this;
var this__4384__auto____$1 = this;
return (new dungeon_builder.scripts.persistence.map_rep(self__.name,self__.tile_state,self__.terrain_state,G__22145,self__.__extmap,self__.__hash));
});
 ...
 */
dungeon_builder.scripts.persistence.map__GT_map_rep = (function dungeon_builder$scripts$persistence$map__GT_map_rep(G__22149){
var extmap__4424__auto__ = (function (){var G__22158 = cljs.core.dissoc.call(null,G__22149,new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"tile-state","tile-state",1272649318),new cljs.core.Keyword(null,"terrain-state","terrain-state",-2032901945));
if(cljs.core.record_QMARK_.call(null,G__22149)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__22158);
} else {
return G__22158;
}
})();
return (new dungeon_builder.scripts.persistence.map_rep(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(G__22149),new cljs.core.Keyword(null,"tile-state","tile-state",1272649318).cljs$core$IFn$_invoke$arity$1(G__22149),new cljs.core.Keyword(null,"terrain-state","terrain-state",-2032901945).cljs$core$IFn$_invoke$arity$1(G__22149),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
...
dungeon_builder.scripts.persistence.save_map = (function dungeon_builder$scripts$persistence$save_map(name,tile_state,terrain_state){
