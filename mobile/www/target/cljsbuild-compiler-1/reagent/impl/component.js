...
if((i < len)){
var k = (ks[i]);
var G__21926 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__21927 = (i + (1));
m = G__21926;
i = G__21927;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__21929 = c;
var G__21929__$1 = (((G__21929 == null))?null:G__21929.prototype);
if((G__21929__$1 == null)){
return null;
} else {
return (G__21929__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__21931 = c;
var G__21931__$1 = (((G__21931 == null))?null:G__21931.prototype);
if((G__21931__$1 == null)){
return null;
} else {
return (G__21931__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__21934__delegate = function (args){
...
while (G__21935__i < G__21935__a.length) {G__21935__a[G__21935__i] = arguments[G__21935__i + 0]; ++G__21935__i;}
  args = new cljs.core.IndexedSeq(G__21935__a,0,null);
} 
return G__21934__delegate.call(this,args);};
G__21934.cljs$lang$maxFixedArity = 0;
G__21934.cljs$lang$applyTo = (function (arglist__21936){
var args = cljs.core.seq(arglist__21936);
return G__21934__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__21938 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21939 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21939;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21938;
}});
...
return ((function (G__21940,G__21940__$1){
...
var c = this;
var G__21945_21947 = (c["cljsRatom"]);
if((G__21945_21947 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__21945_21947);
}
...
var renders_21949 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_21950 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_21949));
if((cljs.core.count.call(null,renders_21949) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_21949))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_21950)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_21950)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__21948 = name;
switch (G__21948) {
case "":
...
var G__21952 = o;
(G__21952[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__21953 = fiber;
var G__21953__$1 = (((G__21953 == null))?null:(G__21953["type"]));
if((G__21953__$1 == null)){
return null;
} else {
return (G__21953__$1["displayName"]);
}
})();
var parent = (function (){var G__21954 = fiber;
if((G__21954 == null)){
return null;
} else {
return (G__21954["return"]);
}
})();
var path = (function (){var G__21955 = parent;
var G__21955__$1 = (((G__21955 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__21955));
if((G__21955__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21955__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__21957 = c;
if((G__21957 == null)){
return null;
} else {
return (G__21957["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__21958._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__21960 = c;
if((G__21960 == null)){
return null;
} else {
return (G__21960["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__21962 = c;
if((G__21962 == null)){
return null;
} else {
return G__21962._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__21964 = instance;
if((G__21964 == null)){
return null;
} else {
return (G__21964["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__21965 = instance;
if((G__21965 == null)){
return null;
} else {
return G__21965._currentElement;
}
}
})();
...
var owner = (function (){var or__4131__auto__ = (function (){var G__21968 = elem;
if((G__21968 == null)){
return null;
} else {
return (G__21968["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__21969._owner;
}
}
})();
var path = (function (){var G__21970 = owner;
var G__21970__$1 = (((G__21970 == null))?null:reagent.impl.component.component_path.call(null,G__21970));
if((G__21970__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21970__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__21971 = c;
var G__21971__$1 = (((G__21971 == null))?null:G__21971.constructor);
if((G__21971__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__21971__$1);
}
}
})();
